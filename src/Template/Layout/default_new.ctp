...
<head>
  ...
  <!-- Font Awesome -->
  <?= $this->Html->css('../dashboard/plugins/fontawesome-free/css/all.min.css') ?>
  <!-- Theme style -->
  <?= $this->Html->css('../dashboard/dist/css/adminlte.min.css') ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Ho Phuoc Trung</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="dashboard/starter.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Starter Page</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="dashboard/iframe.html" class="nav-link">
...
<!-- jQuery -->
<?=  $this->Html->script('../dashboard/plugins/jquery/jquery.min.js')?>
<!-- Bootstrap 4 -->
<?=  $this->Html->script('../dashboard/plugins/bootstrap/js/bootstrap.bundle.min.js')?>
<!-- AdminLTE App -->
<?=  $this->Html->script('../dashboard/dist/js/adminlte.min.js')?>
